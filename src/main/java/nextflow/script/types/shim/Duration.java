...
interface DurationOps {
    ...
    Duration minus(Duration a, Duration b);

    Duration multiply(Duration a, Float b);

    Duration ofType(Integer n);

    Duration ofType(String s);

    Duration plus(Duration a, Duration b);
